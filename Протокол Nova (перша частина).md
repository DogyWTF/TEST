  ...
  <tbody>
    ...
    <tr>
      ...
      <td><b>Формат даних: <a href="#REMOTE_COMMAND">REMOTE_COMMAND</a>
       <br/> Формат підтвердження: <a href="#READ_ACK">READ_ACK</a> </b>
...
<b>DATA1 ... DATAn</b> (до 492 байт) - запитані дані.
    ...
    <tr>
      ...
      <td><b>Формат даних: <a href="#REMOTE_COMMAND">REMOTE_COMMAND</a>
       <br/> Формат підтвердження: <a href="#COMMAND_ACK">COMMAND_ACK</a> </b>
       <br/> </b>Формат даних у полях DATA <a href="#REMOTE_COMMAND">REMOTE_COMMAND</a>: </b>записи довільної довжини у вигляді набору символів, у кодуванні ASCII.  
    ...
    <tr>
      ...
      <td><b>Формат даних: <a href="#REMOTE_COMMAND">REMOTE_COMMAND</a>
       <br/> Формат підтвердження: <a href="#READ_ACK">READ_ACK</a> </b>
       <br/> </b>Формат даних у полях DATA <a href="#REMOTE_COMMAND">REMOTE_COMMAND</a>: </b>
    ...
    <tr>
      <td>0х0A23</td>
      <td>З апис статичного ключа шифрування</td>
      <td><b>Формат даних: <a href="#REMOTE_COMMAND">REMOTE_COMMAND</a>
       <br/> Формат підтвердження: <a href="#COMMAND_ACK">COMMAND_ACK</a>
       <br/> Формат даних у полях DATA: 
